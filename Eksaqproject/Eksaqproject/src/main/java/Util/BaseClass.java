...
public class BaseClass {
	...
	public static void setUp() {
		...
		ExtentSparkReporter htmlReporter = new ExtentSparkReporter(System.getProperty("user.dir") + "\\Report\\report.html");
		htmlReporter.config().setReportName("EKsaq_Project Automation Result");
		htmlReporter.config().setDocumentTitle("Eksaq_Project Automation");
